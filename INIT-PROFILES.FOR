...
C... Written by P. Richards Summer 2010
      ...
      IF(DABS(HPEQ).LT.0.1.OR.HPEQ.GT.2.0) HPEQ=1.0
      !... set default HPEQ for a full flux tube
      HP_FULL=1.22E5/PCO**4
      !... if value between 0.1 and 1.0, take fraction of HP_FULL
      HPEQ=DABS(HPEQ)*HP_FULL
      IF(HPEQ.LT.30) HPEQ=30
      RETURN
      END
C::::::::::::::::::::::::::::::: PROFIN ::::::::::::::::::::::::::::::::::
C....... set up rough initial O+, H+, and temperature profiles
 ...
 90   FORMAT(1X,'PROFIN4',2I7,F8.0,1P,9E10.2)
      RETURN
      END
C:::::::::::::::::: NEW_HP ::::::::::::::::::::::::
...
C... Written by P. Richards September 2010
     ...
     >                 EFLAG)     !.. Error flag array
      ...
      !.. Equatorial density for a depleted flux tube (10% full). Not less than 30
      HP_MIN=30+1.22E4/PCO**4
